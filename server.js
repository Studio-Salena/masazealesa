...
// -- Klientky (Fáze 6D) — zdroj pravdy pro CRM (starý model "zakaznici" +
// odvozené seskupování podle telefonu byl odstraněn ve Fázi 7B.2). Stejná
// pravidla jako Fáze 6B, jen napojení přes klientka_id (skutečná FK), ne
// přes shodu telefonního řetězce:
